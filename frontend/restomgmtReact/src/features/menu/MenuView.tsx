...
import { setActiveTab, type MenuCategoryTab, type MenuItem } from './menuSlice';

export const MenuView: React.FC = () => {
    const dispatch = useDispatch();

    //grabbing data from from global Redux menu cloud
    const { items, activeTab } = useSelector((state: RootState) => state.menu);
